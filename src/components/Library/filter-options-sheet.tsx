...
export const FilterOptionsSheet = ({
  ...
  const operatorDescription = type === "genres" ? "Match selected genres" : "Match selected tags";
    ...
    >
      <View style={{ flex: 1, backgroundColor: themeColors.bg }}>
        ...
        >
          ...
          >
            <Text style={{ color: themeColors.text, fontWeight: "700", fontSize: 22 }}>
              {title}
            </Text>
            <Pressable onPress={onClose} hitSlop={10}>
              <Text style={{ color: themeColors.accent, fontWeight: "600", fontSize: 16 }}>
                Done
              </Text>
            </Pressable>
          </View>
